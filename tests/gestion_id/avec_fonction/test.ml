...
let pathFichiersRat =
  "../../../../../tests/gestion_id/avec_fonction/fichiersRat/"
...
let%test_unit "testDoubleDeclarationVariable1" =
  try
    let _ = compiler (pathFichiersRat ^ "testDoubleDeclarationVariable1.rat") in
...
let%test_unit "testDoubleDeclarationVariable4" =
  try
    let _ = compiler (pathFichiersRat ^ "testDoubleDeclarationVariable4.rat") in
    raise ErreurNonDetectee
  with DoubleDeclaration "x" -> ()

let%test_unit "testDoubleDeclarationVariable5" =
  try
    let _ = compiler (pathFichiersRat ^ "testDoubleDeclarationVariable5.rat") in
    raise ErreurNonDetectee
  with DoubleDeclaration "x" -> ()

let%test_unit "testDoubleDeclarationVariable6" =
  try
    let _ = compiler (pathFichiersRat ^ "testDoubleDeclarationVariable6.rat") in
    raise ErreurNonDetectee
  with DoubleDeclaration "x" -> ()

let%test_unit "testDoubleDeclarationVariable7" =
  try
    let _ = compiler (pathFichiersRat ^ "testDoubleDeclarationVariable7.rat") in
    raise ErreurNonDetectee
  with DoubleDeclaration "x" -> ()
...
let%test_unit "testUtilisation4" =
  try
    let _ = compiler (pathFichiersRat ^ "testUtilisation4.rat") in
    raise ErreurNonDetectee
  with MauvaiseUtilisationIdentifiant "add" -> ()
...
let%test_unit "testUtilisation8" =
  try
    let _ = compiler (pathFichiersRat ^ "testUtilisation8.rat") in
    raise ErreurNonDetectee
  with MauvaiseUtilisationIdentifiant "x" -> ()

let%test_unit "testUtilisation9" =
  try
    let _ = compiler (pathFichiersRat ^ "testUtilisation9.rat") in
    raise ErreurNonDetectee
  with MauvaiseUtilisationIdentifiant "z" -> ()
...
let%test_unit "testUtilisation21" =
  try
    let _ = compiler (pathFichiersRat ^ "testUtilisation21.rat") in
    raise ErreurNonDetectee
  with IdentifiantNonDeclare "y" -> ()

let%test_unit "testUtilisation22" =
  try
    let _ = compiler (pathFichiersRat ^ "testUtilisation22.rat") in
    raise ErreurNonDetectee
  with IdentifiantNonDeclare "y" -> ()

let%test_unit "testUtilisation23" =
  try
    let _ = compiler (pathFichiersRat ^ "testUtilisation23.rat") in
    raise ErreurNonDetectee
  with IdentifiantNonDeclare "x" -> ()

let%test_unit "testUtilisation24" =
  try
    let _ = compiler (pathFichiersRat ^ "testUtilisation24.rat") in
    raise ErreurNonDetectee
  with IdentifiantNonDeclare "x" -> ()

let%test_unit "testUtilisation25" =
  try
    let _ = compiler (pathFichiersRat ^ "testUtilisation25.rat") in
    raise ErreurNonDetectee
  with IdentifiantNonDeclare "a" -> ()

let%test_unit "testUtilisation26" =
  try
    let _ = compiler (pathFichiersRat ^ "testUtilisation26.rat") in
    raise ErreurNonDetectee
  with IdentifiantNonDeclare "a" -> ()
...
let%test_unit "testDoubleDeclarationFonction" =
  try
    let _ = compiler (pathFichiersRat ^ "testDoubleDeclarationFonction.rat") in
    raise ErreurNonDetectee
  with DoubleDeclaration "add" -> ()

let%test_unit "testDoubleDeclarationParametre1" =
  try
    let _ =
      compiler (pathFichiersRat ^ "testDoubleDeclarationParametre1.rat")
    in
    raise ErreurNonDetectee
  with DoubleDeclaration "a" -> ()

let%test_unit "testDoubleDeclarationParametre2" =
  try
    let _ =
      compiler (pathFichiersRat ^ "testDoubleDeclarationParametre2.rat")
    in
    raise ErreurNonDetectee
  with DoubleDeclaration "a" -> ()
...
let%test_unit "testRetourFonction" =
  try
    let _ = compiler (pathFichiersRat ^ "testRetourFonction.rat") in
    raise ErreurNonDetectee
  with RetourDansMain -> ()
...
let%test_unit "testStatiqueLocale2" =
  try
    let _ = compiler (pathFichiersRat ^ "testStatiqueLocale2.rat") in
    raise ErreurNonDetectee
