...
let%expect_test "testfun13" =
  runtam (pathFichiersRat ^ "testfun13.rat");
  [%expect {| 45 |}]

let%expect_test "testfun14" =
  runtam (pathFichiersRat ^ "testfun14.rat");
  [%expect {| 12 |}]

let%expect_test "testfun15" =
  runtam (pathFichiersRat ^ "testfun15.rat");
  [%expect {| 5656 |}]
